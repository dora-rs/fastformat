...
impl BBox {
    ...
    pub fn xywh_to_ndarray_view_mut(
        &mut self,
    ) -> Result<(
...
mod tests {
    ...
    fn test_xywh_to_ndarray() {
        ...
        bbox.xywh_to_ndarray().unwrap();
    }

    #[test]
    fn test_xywh_to_ndarray_view() {
        use crate::bbox::BBox;
        ...
        bbox.xywh_to_ndarray_view().unwrap();
    }

    #[test]
    fn test_xywh_to_ndarray_view_mut() {
        use crate::bbox::BBox;
        ...
        bbox.xywh_to_ndarray_view_mut().unwrap();
    }
    ...
    fn test_xywh_ndarray_zero_copy_conversion() {
        ...
        let (data, confidence, label) = bbox.xywh_to_ndarray().unwrap();
